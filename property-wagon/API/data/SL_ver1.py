...
# LOAD DATA
recent_tnx = pd.read_csv('property_wagon/API/data/recent_tnx.csv')
...
def predict(postal_code):
    ...
    # Load data
    train_data = pd.read_csv('../data/resale-flat-prices-from-2003-2023.csv')
    econ_data = pd.read_csv('../data/econ_data.csv')
