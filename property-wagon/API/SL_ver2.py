    ...
    if submit_button:
        ...
        for i in flattypelist:
            ...
            if pathtofile.is_file():
                ...
                fig = px.line(plot_df3, x="Date", y=["Resale_Price","Resale_Price_Forecast"],line_shape="spline",color="Light24", render_mode="svg",title=f'Average Resale {i} HDB Price in {town}')
